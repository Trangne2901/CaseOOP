public class Test {
    public static void main(String[] args) {
        Student student = new Student("Trang",19,"BIS2300444");
        Student student1 = new Student("Trang",15,"BIS2300443");
        Student student2 = new Student("Trang",10,"BIS2300442");
        ...
        Course course1 = new Course("LTHDT","123");
